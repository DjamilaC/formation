...
class B extends A 
{
    public function calcul()// redéfinition
    {
        ...
        // Une surcharge permet de prendre en compte le comportement de la fonction d'origine et d'y ajouter un traitement complémentaire
...
// Exo : instancier la classe B et afficher le resultat de la condition

$b = new B;
echo '<pre>'; var_dump($b); echo'</pre><hr>';
echo $b->calcul();
...
$homme->setPrenom("Emma"); // OU $homme->setPrenom($_POST['prenom']); (exactement pareil 'on recupere le contenu du champs nom sais dand le formulaire)
